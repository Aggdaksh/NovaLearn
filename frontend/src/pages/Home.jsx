...
function Home() {
  ...
  return (
    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='w-[100%] h-[72vh] md:h-auto relative overflow-hidden bg-black'>
        <Nav/>
        <img src={home} className='w-[100%] h-[100%] object-cover object-top md:h-auto' alt="" />
        <span className='lg:text-[70px] absolute  md:text-[40px]  lg:top-[9%] top-[16%] w-[100%] flex items-center justify-center text-white font-bold text-[20px] '>
          Grow Your Skills to Advance 
        </span>
        <span className='lg:text-[70px] text-[20px] md:text-[40px] absolute lg:top-[18%] top-[24%] w-[100%] flex items-center justify-center text-white font-bold'>
          Your Career path
        </span>
        <div className='absolute lg:top-[30%] top-[74%]  md:top-[78%] w-[100%] flex items-center justify-center gap-3 flex-wrap px-[16px]'>
